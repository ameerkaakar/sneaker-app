...
class BuyerResetPassword extends StatefulWidget {
  @override
  _BuyerResetPasswordState createState() => _BuyerResetPasswordState();
}

class _BuyerResetPasswordState extends State<BuyerResetPassword> {
  @override
